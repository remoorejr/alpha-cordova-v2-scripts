...
echo   1. Shut down the background Dev Container (alphacordova).
...
:: Confirmation Step (Sanitized to strip accidental trailing spaces)
set "CONFIRM="
set /p "CONFIRM=👉 Type 'Y' and press Enter to proceed, or any other key to cancel: "

:: Strip potential surrounding quotes or trailing whitespace spaces
if defined CONFIRM (
    set "CONFIRM=!CONFIRM: =!"
)
...
:: Targeting the explicit project name 'alphacordova' to resolve the lookup failure
docker compose -p alphacordova down -v --remove-orphans --timeout 2

echo.
echo 🔥 [PURGE] Initializing Docker Janitor to clean host files...
:: Run as UID 1000 to cleanly match the file system footprints generated by cordovauser
docker run --rm -v "%TARGET_DIR%:/home/cordovauser/app" -u 1000:1000 alpine sh -c "rm -rf /home/cordovauser/app/platforms /home/cordovauser/app/plugins /home/cordovauser/app/node_modules /home/cordovauser/app/debug /home/cordovauser/app/.turbo_ready /home/cordovauser/app/android_cache"
